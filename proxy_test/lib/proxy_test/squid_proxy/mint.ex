defmodule ProxyTest.SquidProxy.Mint do
  @doc """
  Proxy with mint to something not allowed
  """
  def bad_request do
    case Mint.HTTP.connect(:https, "yahoo.com", 443, ProxyTest.SquidProxy.connection_options()) do
      {:error,
  ...
  def good_request do
    case Mint.HTTP.connect(
           ...
           "www.google.com",
           443,
           ProxyTest.SquidProxy.connection_options()
         ) do
      {:ok, conn} ->
